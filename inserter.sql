INSERT INTO `parts_main` (`number`, `description`, `price`, `weight`, `pictureURL`) VALUES
...
UPDATE `parts_main` SET qty = 5;

INSERT INTO `ORDERS`(`ORDER_NUM`, `ORDER_DATE`, `CUS_NAME`, `CUS_EMAIL`, `CUS_ADDRESS`, `TOTAL`, `ORDER_WEIGHT`, `STATUS`, `TRACKING`) VALUES
  (1, '2023-05-04', 'Darth Vader', 'sith@darkside.com', 'Death Star 1', '64.49', '519.75', 'CANCELLED', 'NULL'),
  (2, '2023-05-04', 'The President', 'potus@whitehouse.gov', 'Da Capitol', '34.99', '126.9', 'RECIEVED', 'NULL'),
  (3, '2023-05-04', 'Dev Ops', 'developer@operations.net', 'Broadway Board 1337', '12.99', '25.38', 'SHIPPED', '800123904566');

INSERT INTO `WEIGHT`(`MIN`,`MAX`,`COST`) VALUES
    (0,5,1.99),
    (5.01,20,5.99),
    (20.01,50,10.99),    
    (50.01,100,15.99),
...
INSERT INTO `HAS`(`ORDER_NUM`, `NUM`, `DESC`, `WEIGHT`, `QTY`) VALUES
  (1,9,'inter cooler sweep','202.17',2),
  (1,135,'2002 Yamaha YZR M1','38.47',3),
  (2,10,'gas cap - chrome','25.38',5),
  (3,19,'trunk liner','25.38',1);